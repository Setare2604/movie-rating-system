...
Revision ID: 5aaf9d672e1c
Revises: 
Create Date: 2025-12-29 20:36:41.828803
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('movie_id', 'genre_id', name='uq_genres_movie_movie_genre')
    )
    ...
    sa.CheckConstraint('score >= 1 AND score <= 10', name='ck_movie_ratings_score_range'),
    sa.ForeignKeyConstraint(['movie_id'], ['movies.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
